 ...
 * @param startPlayTime   the time when the quest was started
 * @param completPlayTime the time when the quest was completed
 */
public record CompletedQuest(Quest quest, Date completedAt, Date startedAt, boolean isFavorite, long startPlayTime,
                             long completPlayTime) {
}