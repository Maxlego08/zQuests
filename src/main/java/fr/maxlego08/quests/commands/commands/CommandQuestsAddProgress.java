...
public class CommandQuestsAddProgress extends VCommand {

    public CommandQuestsAddProgress(QuestsPlugin plugin) {
        super(plugin);
        this.setPermission(Permission.ZQUESTS_ADD_PROGRESS);
        this.addSubCommand("add-progress");
        this.setDescription(Message.DESCRIPTION_ADD_PROGRESS);
    ...
    protected CommandType perform(QuestsPlugin plugin) {
        ...
        plugin.getQuestManager().addQuestProgress(sender, player, questName, amount);
