...
public class QuestActiveLoader extends ButtonLoader {

    private final QuestsPlugin plugin;

    public QuestActiveLoader(QuestsPlugin plugin) {
        super(plugin, "ZQUESTS_ACTIVE");
        this.plugin = plugin;
    }
    ...
    public Button load(YamlConfiguration configuration, String path, DefaultButtonValue defaultButtonValue) {
        ...
        return new QuestActiveButton(this.plugin, quests);
    }
}
