...
public class RemoveFavoriteLimitButton extends ZButton {

    private final QuestsPlugin plugin;

    public RemoveFavoriteLimitButton(Plugin plugin) {
    ...
    public boolean checkPermission(Player player, InventoryDefault inventory, Placeholders placeholders) {
        ...
        return super.checkPermission(player, inventory, placeholders) && (this.plugin.getQuestManager().getUserQuest(player.getUniqueId()).getFavoriteLimit() > placeholderFavorite.minFavorite());
    }
    ...
    public void onClick(Player player, InventoryClickEvent event, InventoryDefault inventory, int slot, Placeholders placeholders) {
        ...
        if (newLimit < placeholderFavorite.minFavorite()) newLimit = placeholderFavorite.minFavorite();
